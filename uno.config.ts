...
export default defineConfig({
  ...
  shortcuts: {
    ...
    "btn-base":
      "inline-flex items-center justify-center font-medium rounded-lg transition-all focus:outline-none focus:ring-4 disabled:opacity-50 disabled:cursor-not-allowed touch-target",

    // Primary action buttons (submit, continue)
    "btn-primary":
      "btn-base px-6 py-3 bg-blue-600 text-white hover:bg-blue-700 active:bg-blue-800 focus:ring-blue-300",
    "btn-primary-sm":
      "btn-base px-4 py-2 text-sm bg-blue-600 text-white hover:bg-blue-700 active:bg-blue-800 focus:ring-blue-300",
    "btn-primary-lg":
      "btn-base px-8 py-4 text-lg bg-blue-600 text-white hover:bg-blue-700 active:bg-blue-800 focus:ring-blue-300",

    // Success/positive buttons (Requirement 8.2 - Positive Feedback)
    "btn-success":
      "btn-base px-6 py-3 bg-green-600 text-white hover:bg-green-700 active:bg-green-800 focus:ring-green-300",
    "btn-success-sm":
      "btn-base px-4 py-2 text-sm bg-green-600 text-white hover:bg-green-700 active:bg-green-800 focus:ring-green-300",

    // Warning/gentle correction buttons (Requirement 8.3 - Gentle Correction)
    "btn-warning":
      "btn-base px-6 py-3 bg-orange-500 text-white hover:bg-orange-600 active:bg-orange-700 focus:ring-orange-300",
    "btn-warning-sm":
      "btn-base px-4 py-2 text-sm bg-orange-500 text-white hover:bg-orange-600 active:bg-orange-700 focus:ring-orange-300",

    // Secondary buttons (cancel, skip)
    "btn-secondary":
      "btn-base px-6 py-3 bg-white text-gray-700 border-2 border-gray-300 hover:border-blue-400 hover:bg-blue-50 active:bg-blue-100 focus:ring-blue-300",
    "btn-secondary-sm":
      "btn-base px-4 py-2 text-sm bg-white text-gray-700 border-2 border-gray-300 hover:border-blue-400 hover:bg-blue-50 active:bg-blue-100 focus:ring-blue-300",
    "btn-secondary-lg":
      "btn-base px-8 py-4 text-lg bg-white text-gray-700 border-2 border-gray-300 hover:border-blue-400 hover:bg-blue-50 active:bg-blue-100 focus:ring-blue-300",

    // Ghost/text buttons (hints, solutions, less emphasis)
    "btn-ghost":
      "btn-base px-4 py-2 text-gray-700 hover:bg-gray-100 active:bg-gray-200 focus:ring-gray-300",
    "btn-ghost-sm":
      "btn-base px-3 py-1.5 text-sm text-gray-700 hover:bg-gray-100 active:bg-gray-200 focus:ring-gray-300",

    // Icon-only buttons (close, expand, navigation)
    "btn-icon":
      "touch-target flex items-center justify-center rounded-lg transition-colors focus:outline-none focus:ring-2 focus:ring-offset-2 hover:bg-gray-100 active:bg-gray-200",
    "btn-icon-sm":
      "min-w-36px min-h-36px flex items-center justify-center rounded-lg transition-colors focus:outline-none focus:ring-2 focus:ring-offset-2 hover:bg-gray-100 active:bg-gray-200",
    "btn-icon-primary":
      "touch-target flex items-center justify-center rounded-lg bg-blue-600 text-white hover:bg-blue-700 active:bg-blue-800 transition-colors focus:outline-none focus:ring-2 focus:ring-blue-300 focus:ring-offset-2",
    ...
    "card-interactive":
      "card hover:shadow-xl hover:border-blue-500 border-2 border-transparent transition-all cursor-pointer focus:outline-none focus:ring-4 focus:ring-blue-300",
    ...
    "card-success":
      "card bg-green-50 border-2 border-green-200 dark:bg-green-900/20 dark:border-green-700",
    "card-warning":
      "card bg-orange-50 border-2 border-orange-200 dark:bg-orange-900/20 dark:border-orange-700",
    "card-error": "card bg-red-50 border-2 border-red-200 dark:bg-red-900/20 dark:border-red-700",
    "card-info":
      "card bg-blue-50 border-2 border-blue-200 dark:bg-blue-900/20 dark:border-blue-700",
    ...
    "input-base":
      "w-full px-4 py-3 rounded-lg border-2 border-gray-300 bg-white text-gray-900 placeholder-gray-400 focus:outline-none focus:border-blue-500 focus:ring-4 focus:ring-blue-200 transition-colors touch-target dark:bg-gray-800 dark:border-gray-600 dark:text-gray-100",
    input: "input-base",
    "input-sm":
      "w-full px-3 py-2 text-sm rounded-lg border-2 border-gray-300 bg-white text-gray-900 placeholder-gray-400 focus:outline-none focus:border-blue-500 focus:ring-4 focus:ring-blue-200 transition-colors dark:bg-gray-800 dark:border-gray-600 dark:text-gray-100",
    "input-lg":
      "w-full px-5 py-4 text-lg rounded-lg border-2 border-gray-300 bg-white text-gray-900 placeholder-gray-400 focus:outline-none focus:border-blue-500 focus:ring-4 focus:ring-blue-200 transition-colors touch-target dark:bg-gray-800 dark:border-gray-600 dark:text-gray-100",
    ...
    "badge-mastery-introduced":
      "badge-base bg-red-100 text-red-800 dark:bg-red-900/30 dark:text-red-300",
    "badge-mastery-developing":
      "badge-base bg-yellow-100 text-yellow-800 dark:bg-yellow-900/30 dark:text-yellow-300",
    "badge-mastery-progressing":
      "badge-base bg-lime-100 text-lime-800 dark:bg-lime-900/30 dark:text-lime-300",
    "badge-mastery-proficient":
      "badge-base bg-green-100 text-green-800 dark:bg-green-900/30 dark:text-green-300",
    "badge-mastery-mastered":
      "badge-base bg-blue-100 text-blue-800 dark:bg-blue-900/30 dark:text-blue-300",

    // Status badges
    "badge-success":
      "badge-base bg-green-100 text-green-800 dark:bg-green-900/30 dark:text-green-300",
    "badge-warning":
      "badge-base bg-orange-100 text-orange-800 dark:bg-orange-900/30 dark:text-orange-300",
    ...
    "badge-count":
      "inline-flex items-center justify-center min-w-5 h-5 px-1.5 rounded-full bg-red-500 text-white text-xs font-bold",
    "badge-count-sm":
      "inline-flex items-center justify-center min-w-4 h-4 px-1 rounded-full bg-red-500 text-white text-2xs font-bold",
    ...
    "skip-link":
      "sr-only focus:not-sr-only focus:absolute focus:top-4 focus:left-4 focus:z-tooltip focus:px-4 focus:py-2 focus:bg-blue-600 focus:text-white focus:rounded focus:shadow-lg",
