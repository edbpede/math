...
export default function SyncStatusIndicator() {
  ...
  return (
    <div class="fixed bottom-4 right-4 z-50">
      ...
      >
        {/* Status dot */}
        <div class={`w-3 h-3 rounded-full ${getStatusColor()} ${syncStatus().syncing || syncing() ? 'animate-pulse' : ''}`} />
        ...
        <div class="absolute bottom-full right-0 mb-2 w-80 bg-white dark:bg-gray-800 rounded-lg shadow-xl border border-gray-200 dark:border-gray-700 p-4">
          ...
          <div class="mb-3">
            <div class="flex items-center gap-2 mb-1">
              <div class={`w-2 h-2 rounded-full ${networkStatus().online ? 'bg-green-500' : 'bg-red-500'}`} />
          ...
          <Show when={networkStatus().online}>
            ...
            >
              <Show when={syncStatus().syncing || syncing()} fallback={t()('sync.ui.manualSync')}>
