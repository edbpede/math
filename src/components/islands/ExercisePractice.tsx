        ...
        {(ex) => (
          <div class="exercise-content bg-white rounded-lg shadow-md p-8">
            ...
            <Show when={hasSubmitted && state.status === "correct"}>
              <FeedbackDisplay
                isCorrect={true}
                message={state.status === "correct" ? state.message : ""}
            ...
            <Show when={hasSubmitted && state.status === "incorrect"}>
              <FeedbackDisplay
                isCorrect={false}
                message={state.status === "incorrect" ? state.message : ""}
                correctAnswer={
                  state.status === "incorrect" && "correctAnswer" in state
                    ? state.correctAnswer
                    : String(ex().correctAnswer.value)
                }
                userAnswer={answer()}
                workedSolution={ex().workedSolution}
                visualAid={ex().visualAid}
