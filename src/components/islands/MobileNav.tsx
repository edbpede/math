...
export default function MobileNav(props: MobileNavProps) {
  ...
  const navItems = (): NavItem[] => {
    ...
    return [
      ...
      { label: translations('navigation.menu.dashboard'), href: '/dashboard', icon: 'dashboard' },
      { label: translations('navigation.menu.practice'), href: '/practice', icon: 'practice' },
      { label: translations('navigation.menu.progress'), href: '/progress', icon: 'progress' },
      { label: translations('navigation.menu.settings'), href: '/settings', icon: 'settings' },
      { label: translations('navigation.menu.help'), href: '/help', icon: 'help' },
    ]
  }
 ...
 */
function getNavIcon(icon: string): JSX.Element {
  switch (icon) {
    case 'home':
      return (
