...
describe("Answer Validation System", () => {
  ...
  describe("security: XSS prevention", () => {
    ...
    it("should reject event handler attempts", () => {
      const eventHandlers = ['onclick=alert("XSS")', "onerror=steal()", "onload=malicious()"];
  ...
  describe("security: injection prevention", () => {
    it("should reject SQL injection attempts", () => {
      const sqlInjection = ["'; DROP TABLE users; --", "1' OR '1'='1", "admin'--"];
    ...
    it("should reject command injection attempts", () => {
      const commandInjection = ["42; ls -la", "42 && rm -rf /", "42 | cat /etc/passwd"];
  ...
  describe("security: malicious pattern detection", () => {
    it("should detect and reject document/window access attempts", () => {
      const domAccess = ["document.cookie", "window.location", "document.getElementById"];
