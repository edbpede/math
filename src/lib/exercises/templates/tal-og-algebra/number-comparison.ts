...
import type { Answer, ExerciseTemplate, ValidationResult } from "../../types";
...
export const numberComparisonTemplates = [numberComparisonA, numberComparisonB, numberComparisonC];
