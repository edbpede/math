...
import type { ExerciseTemplate, TemplateSelectionCriteria } from './types';

// Helper function to create a minimal valid template
const createValidTemplate = (id: string, overrides: Partial<ExerciseTemplate> = {}): ExerciseTemplate => {
  return {
    id,
...
describe('TemplateRegistry', () => {
  ...
  describe('Template Unregistration', () => {
    ...
    it('should remove template from all indexes', () => {
      ...
      const byCompetency = registry.find({ competencyAreaId: 'tal-og-algebra' });
  ...
  describe('Multi-Criteria Indexing', () => {
    beforeEach(() => {
      ...
      registry.register(createValidTemplate('tal-0-3-a', {
        metadata: {
          competencyAreaId: 'tal-og-algebra',
          skillsAreaId: 'tal-addition',
          gradeRange: '0-3',
      ...
      registry.register(createValidTemplate('tal-0-3-b', {
        metadata: {
          competencyAreaId: 'tal-og-algebra',
      ...
      registry.register(createValidTemplate('tal-4-6-a', {
        metadata: {
          competencyAreaId: 'tal-og-algebra',
      ...
      registry.register(createValidTemplate('geo-0-3-a', {
        metadata: {
      ...
      registry.register(createValidTemplate('geo-4-6-c', {
        metadata: {
          competencyAreaId: 'geometri-og-maling',
  ...
  describe('Template Selection with Weighting', () => {
    beforeEach(() => {
      registry.register(createValidTemplate('binding-a', {
        metadata: {
          competencyAreaId: 'tal-og-algebra',
          skillsAreaId: 'test',
          gradeRange: '0-3',
      ...
      registry.register(createValidTemplate('non-binding-a', {
        metadata: {
          competencyAreaId: 'tal-og-algebra',
          skillsAreaId: 'test',
          gradeRange: '0-3',
      ...
      registry.register(createValidTemplate('difficulty-b', {
        metadata: {
          competencyAreaId: 'tal-og-algebra',
          skillsAreaId: 'test',
          gradeRange: '0-3',
      ...
      registry.register(createValidTemplate('difficulty-c', {
        metadata: {
          competencyAreaId: 'tal-og-algebra',
          skillsAreaId: 'test',
          gradeRange: '0-3',
  ...
  describe('Edge Cases', () => {
    ...
    it('should handle all valid competency areas', () => {
      const areas: Array<'matematiske-kompetencer' | 'tal-og-algebra' | 'geometri-og-maling' | 'statistik-og-sandsynlighed'> = [
