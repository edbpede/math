...
export class OfflineStorage {
  ...
  async init(): Promise<void> {
    ...
    try {
      ...
      this.dbPromise = null;
      throw new StorageError("Failed to initialize database", "init", error);
    }
  }
  ...
  async clearAll(): Promise<void> {
    try {
      ...
      const tx = db.transaction(
        ["exercises", "syncQueue", "progressCache", "preferences"],
        "readwrite",
      );
  ...
  async addExercise(instance: ExerciseInstance): Promise<void> {
    try {
      ...
      throw new StorageError(`Failed to add exercise ${instance.id}`, "addExercise", error);
    }
  }
  ...
  async getExercise(id: string): Promise<ExerciseCacheEntry | undefined> {
    try {
      ...
      throw new StorageError(`Failed to get exercise ${id}`, "getExercise", error);
    }
  }
  ...
  async getUnusedExercises(limit?: number): Promise<ExerciseInstance[]> {
    try {
      ...
      throw new StorageError("Failed to get unused exercises", "getUnusedExercises", error);
    }
  }
  ...
  async markExerciseUsed(id: string): Promise<void> {
    try {
      ...
      throw new StorageError(`Failed to mark exercise ${id} as used`, "markExerciseUsed", error);
    }
  }
  ...
  async clearExercises(): Promise<void> {
    try {
      ...
      throw new StorageError("Failed to clear exercises", "clearExercises", error);
    }
  }
  ...
  async getExercisePoolStats(): Promise<{
    ...
    try {
      ...
      if (allExercises.length > 0) {
        const oldestDate = Math.min(...allExercises.map((entry) => entry.generatedAt.getTime()));
      ...
      throw new StorageError("Failed to get pool stats", "getExercisePoolStats", error);
    }
  }
  ...
  async cleanupOldExercises(cutoffDate: Date): Promise<number> {
    try {
      ...
      const oldExercises = await index.getAll(IDBKeyRange.upperBound(cutoffDate));
      ...
      throw new StorageError("Failed to cleanup old exercises", "cleanupOldExercises", error);
    }
  }
  ...
  async getExerciseCount(): Promise<{ total: number; unused: number }> {
    try {
      ...
      throw new StorageError("Failed to get exercise count", "getExerciseCount", error);
    }
  }
  ...
  async addToSyncQueue(item: Omit<SyncQueueItem, "id">): Promise<number> {
    try {
      ...
      throw new StorageError("Failed to add item to sync queue", "addToSyncQueue", error);
    }
  }
  ...
  async getAllSyncQueue(): Promise<SyncQueueItem[]> {
    try {
      ...
      throw new StorageError("Failed to get all sync queue items", "getAllSyncQueue", error);
    }
  }
  ...
  async clearSyncQueue(): Promise<void> {
    try {
      ...
      throw new StorageError("Failed to clear sync queue", "clearSyncQueue", error);
    }
  }
  ...
  async getSyncQueueCount(): Promise<number> {
    try {
      ...
      throw new StorageError("Failed to get sync queue count", "getSyncQueueCount", error);
    }
  }
  ...
  async setProgressCache(
    ...
    try {
      ...
      throw new StorageError(`Failed to set progress cache for ${type}`, "setProgressCache", error);
    }
  }
  ...
  async getProgressCache(type: ProgressCacheType): Promise<ProgressCacheEntry | undefined> {
    try {
      ...
      throw new StorageError(`Failed to get progress cache for ${type}`, "getProgressCache", error);
    }
  }
  ...
  async clearAllProgressCache(): Promise<void> {
    try {
      ...
      throw new StorageError("Failed to clear all progress cache", "clearAllProgressCache", error);
    }
  }
  ...
  async setPreference(key: string, value: unknown): Promise<void> {
    try {
      ...
      throw new StorageError(`Failed to set preference ${key}`, "setPreference", error);
    }
  }
  ...
  async getPreference(key: string): Promise<unknown | undefined> {
    try {
      ...
      throw new StorageError(`Failed to get preference ${key}`, "getPreference", error);
    }
  }
  ...
  async getAllPreferences(): Promise<Record<string, unknown>> {
    try {
      ...
      throw new StorageError("Failed to get all preferences", "getAllPreferences", error);
    }
  }
  ...
  async removePreference(key: string): Promise<void> {
    try {
      ...
      throw new StorageError(`Failed to remove preference ${key}`, "removePreference", error);
    }
  }
  ...
  async clearPreferences(): Promise<void> {
    try {
      ...
      throw new StorageError("Failed to clear preferences", "clearPreferences", error);
    }
  }
}
