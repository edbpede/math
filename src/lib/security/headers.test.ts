...
describe("getSecurityHeaders", () => {
  test("should generate all security headers for production", () => {
    ...
    expect(headers[SECURITY_HEADERS.RP]).toBe("strict-origin-when-cross-origin");
  ...
  test("should include HSTS header in production", () => {
    ...
    expect(headers[SECURITY_HEADERS.HSTS]).toBe("max-age=63072000; includeSubDomains; preload");
  });
